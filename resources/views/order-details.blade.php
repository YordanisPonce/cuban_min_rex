    ...
    <div class="main">
        ...
        @if ($order->status === 'paid')
            <div class="success-header">
                ...
                <div class="success-text">
                    ...
                    <p>Tu pago fue procesado correctamente.
                        {{ count($purchaseItems) > 0 ? 'Los archivos están listos para descargar.' : '' }}</p>
                </div>
        ...
        @else
            <div class="danger-header">
                <div class="danger-icon"><i class="fas fa-x"></i></div>
                <div class="danger-text">
                    <h1>¡Compra <span>cancelada!</span></h1>
                    <p>Tu pago falló o fue rechazado. Está orden fue cancelada.</p>
                </div>
        ...
        <div class="grid">
            <div>
                ...
                <div class="card">
                    <div class="card-title">{{ $order->order_items->count() > 0 ? $order->order_items->count() : 1 }}
                        Artículo(s)</div>
                    ...
                    @if (count($purchaseItems) > 0)
                            ...
                            <div class="purchase-item">
                                ...
                                <div class="purchase-item-info">
                                    ...
                                    <div class="purchase-item-meta">
                                        <span class="pill"><i class="fas fa-headphones"></i>
                                            {{ strtoupper($item['extension']) }}</span>
                                    </div>
                                </div>
                        ...
                        @endforeach
                        <div class="dl-row">
                            <div class="dl-chip"><i class="fas fa-file-zipper"></i> {{ count($purchaseItems) }} archivos ·
                                {{ array_sum(array_column($purchaseItems, 'size')) }} MB</div>
                            @if ($order->status === 'paid')
                                <a href="{{ route('order.download.all', $order->id) }}" class="dl-btn"><i
                                        class="fas fa-download"></i> Descargar todo</a>
                            @endif
                        </div>
                    @else
                        @if ($order->plan)
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="summary-row"><span>Subtotal</span><span>$ {{ number_format($order->amount, 2) }}</span>
                    </div>
                    <div class="summary-row muted"><span>Descuento</span><span>- $ 0.00</span></div>
                    <div class="summary-row total"><span>TOTAL PAGADO</span><span>$
                            {{ number_format($order->amount, 2) }}</span></div>
                    ...
                    <div class="steps">
                        ...
                        @elseif($order->status === 'pending')
                            ...
                            <div class="step"><span class="dotc"><i class="fas fa-download"></i></span><span
                                    class="lbl">Descargar</span></div>
                        @else
                            <div class="step cancel"><span class="dotc"><i class="fas fa-credit-card"></i></span><span
                                    class="lbl">Pagada</span></div>
                            <div class="step"><span class="dotc"><i class="fas fa-download"></i></span><span
                                    class="lbl">Descargar</span></div>
                        @endif
                ...
                <div style="margin-top:1.5rem;">
                    ...
                    <div class="pay-method">
                        ...
                        @if ($order->status === 'failed')
                            <div class="pm-status canceled">
                                <span class="status-pill">
                                    <span class="dot"></span> Rechazado</span>
                            </div>
                        @else
                            <div class="pm-status">
                                <span class="status-pill">
                                    <span class="dot"></span> Aprobado</span>
                            </div>
                        @endif
                    </div>
                </div>
