                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="col-3">
                                                    <spam class="flex gap-sm-10 gap-1 text-nowrap justify-content-end">
                                                        ...
                                                        @else
                                                        <i>$ {{ $file['price'] }}</i>
                                                        <i><a data-url="{{route('file.pay', $file['id']) }}" style="display: flex; width: 20px; cursor: pointer" onclick="proccessPayment(this.dataset.url)">{{ svg('vaadin-cart') }}</a></i>
                                                        @endif
                                                        @else
                                                        <i>$ {{ $file['price'] }}</i>
                                                        <i><a data-url="{{route('file.pay', $file['id']) }}" style="display: flex; width: 20px; cursor: pointer" onclick="proccessPayment(this.dataset.url)">{{ svg('vaadin-cart') }}</a></i>
                                                        ...
                                                        <i>
                                                            ...
                                                            @else
                                                            <a style="display: flex; width: 20px" class="cursor-pointer" data-url="{{$file['url']}}" data-state="pause" onclick="playAudio(this)">{{ svg('vaadin-play') }}</a>
                                                            @endif
                                                        </i>
                                                    </spam>
                                                </div>
