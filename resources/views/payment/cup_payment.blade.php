        ...
        <div class="steps-container">
            ...
            <div class="card">
                <div class="panel active" id="panel1">
                    <div class="title">
                        <svg width="22" height="22" fill="none" stroke="#3b82f6" stroke-width="2"
                            viewBox="0 0 24 24">
                    ...
                    <div class="terms-box">
                        <p><strong>1. Aceptación de los términos.</strong> Al utilizar este formulario, usted acepta cumplir
                            con los presentes términos y condiciones.</p>
                        <p><strong>2. Uso de la información.</strong> La información proporcionada será utilizada únicamente
                            para los fines descritos y será tratada con confidencialidad.</p>
                        <p><strong>3. Protección de datos.</strong> Nos comprometemos a proteger sus datos personales de
                            acuerdo con la legislación vigente.</p>
                        <p><strong>4. Responsabilidad.</strong> El usuario es responsable de la veracidad de la información
                            proporcionada, debe verificar que sea correcta, no nos responsabilizamos de errores o
                            inconsistencias en los datos enviados.</p>
                        <p><strong>5. Tasa de conversión.</strong> La tasa de conversión de USD a CUP es definida por el
                            sitio, donde 1 USD = {{ $setting->currency_convertion_rate }} CUP</p>
                        <p><strong>6. Contacto.</strong> Para cualquier consulta, puede comunicarse al correo
                            {{ $setting->confirmation_email ?? '' }}.</p>
                    </div>
                    <div class="check-row">
                        <input type="checkbox" id="acceptCheck" />
                        <label for="acceptCheck">He leído y acepto los términos y condiciones descritos
                            anteriormente.</label>
                    </div>
                    ...
                    <form id="payment-form" action="{{ route('payment.cup.proccess', $file->id) }}" method="POST">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="credit_card"
                                value="{{ $setting->credit_card_info ?? 'XXXX-XXXX-XXXX-XXXX' }}" disabled />
                        </div>
                        <div class="field">
                            <label>Monto a depositar en CUP</label>
                            <input type="text" name="price"
                                value="{{ $file->price * $setting->currency_convertion_rate }}" disabled />
                        </div>
                        <div class="field">
                            <label>Número a confirmar</label>
                            <input type="text" name="confirmation"
                                value="{{ $setting->confirmation_phone ?? '+53 XXXX XXXX' }}" disabled />
                        </div>
                        <div class="title">
                            <svg width="22" height="22" fill="none" stroke="#3b82f6" stroke-width="2"
                                viewBox="0 0 24 24">
                        ...
                        <div class="field">
                            ...
                            <input type="email" id="femail" name="email" placeholder="correo@ejemplo.com"
                        ...
                        <div class="field">
                            ...
                            <input type="tel" id="fphone" name="phone" placeholder="+53 xxxx xxxx" maxlength="20"
                                value="{{ Auth::user()?->phone ?? '' }}" />
                            <div class="error-msg" id="errPhone"></div>
                        </div>
                        <div class="field">
                            <label for="fcode">Nro. Transacción *</label>
                            <input type="text" id="fcode" name="code" placeholder="XX###X#XX###"
                                maxlength="255" />
                ...
                <div class="panel" id="panel3">
                    <div class="success">
                        <div class="success-icon">
                            <svg width="36" height="36" fill="none" stroke="#10b981" stroke-width="2.5"
                                viewBox="0 0 24 24">
                        ...
                        <p>Se ha enviado tu información, pronto se confirmara tu pago y se te enviará el archivo a la
                            bandeja de entrada de tu correo.</p>
...
@push('scripts')
    <script>
        ...
        var panels = [document.getElementById('panel1'), document.getElementById('panel2'), document.getElementById(
            'panel3')];
        ...
        var checkSvg =
            '<svg width="18" height="18" fill="none" stroke="#fff" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>';
