        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item relative">
                    <img src="https://th.bing.com/th/id/OIP.H6GK0lclpzeTtEwam6uGWwHaEK?w=207&h=150&c=6&o=7&dpr=1.3&pid=1.7&rm=3"
                        alt="imagine-dragons" class="d-block" style="width:100%">
                    <div class="carousel-caption">
                        <h3>Imagine Dragons</h3>
                        <p><i class="icon-base ti tabler-star-filled"></i>
                ...
                <div class="carousel-item relative">
                    <img src="{{ asset('/assets/img/album/imagine-dragons.png') }}" alt="imagine-dragons" class="d-block"
                        style="width:100%">
                    <div class="carousel-caption">
                        <h3>Imagine Dragons</h3>
                        <p><i class="icon-base ti tabler-star-filled"></i>
                                ...
                                <a class="flex align-items-center"
                                    ...
                                    <i class="ms-1">
                                        <svg fill="currentColor" version="1.1" baseProfile="tiny" id="Layer_1"
                                            ...
                                            xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" width="15px"
                                            height="15px" viewBox="0 0 42 42" xml:space="preserve">
                        ...
                        <div class="{{ $isActive ? 'card border border-primary shadow-xl' : 'card' }}">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ $plan->image }}" alt="paper airplane icon" class="mb-8 pb-2 w-25" />
