                ...
                <div class="swiper-slide" role="group" aria-label="3 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="2">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-3.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                  ...
                  </div><div class="swiper-slide swiper-slide-prev" role="group" aria-label="4 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="3">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-4.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                  ...
                  </div><div class="swiper-slide swiper-slide-active" role="group" aria-label="5 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="4">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-5.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                  ...
                  </div><div class="swiper-slide swiper-slide-next" role="group" aria-label="6 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="5">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-6.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                            <h6 class="mb-0">Sara Smith</h6>
                            <p class="small text-body-secondary mb-0">Founder of Continental</p>
                  ...
                  </div><div class="swiper-slide" role="group" aria-label="1 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="0">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-1.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                  ...
                  </div><div class="swiper-slide" role="group" aria-label="2 / 6" style="width: 254px; margin-right: 26px;" data-swiper-slide-index="1">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/branding/logo-2.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>“I've never used a theme as versatile and flexible as Vuexy. It's my go to for building dashboard sites on almost any project.”</p>
                        <div class="text-warning mb-4">
                          <i class="icon-base ti tabler-star-filled"></i>
        ...
        <div class="row g-6 pt-lg-5">
            ...
            <div class="card">
              <div class="card-header">
                <div class="text-center">
                  <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/paper-airplane.png" alt="paper airplane icon" class="mb-8 pb-2">
              ...
              <div class="card-body">
                ...
                <div class="d-grid mt-8">
                  <a href="https://demos.pixinvent.com/vuexy-html-admin-template/html/front-pages/payment-page.html" class="btn btn-label-primary waves-effect">Get Started</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card border border-primary shadow-xl">
              <div class="card-header">
                <div class="text-center">
                  <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/plane.png" alt="plane icon" class="mb-8 pb-2">
              ...
              <div class="card-body">
                ...
                <div class="d-grid mt-8">
                  <a href="https://demos.pixinvent.com/vuexy-html-admin-template/html/front-pages/payment-page.html" class="btn btn-primary waves-effect waves-light">Get Started</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card">
              <div class="card-header">
                <div class="text-center">
                  <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/shuttle-rocket.png" alt="shuttle rocket icon" class="mb-8 pb-2">
...
<section id="landingFAQ" class="section-py bg-body landing-faq">
      <div class="container">
        ...
        <div class="row gy-12 align-items-center">
          <div class="col-lg-5">
            <div class="text-center">
              <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/landing-page/faq-boy-with-logos.png" alt="faq boy with logos" class="faq-image">
            </div>
          </div>
          <div class="col-lg-7">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="row g-4">
                    ...
                    <div class="col-12">
                      <button type="submit" class="btn btn-primary waves-effect waves-light">Send inquiry</button>
                    </div>
                  </div>
                </form>
              </div>
