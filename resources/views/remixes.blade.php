    ...
    <section class="hero container">
        ...
        <div class="container">
            <h1 data-aos="fade-right" data-aos-delay="300">REMIXES<br>EXCLUSIVOS<br><span class="gold">PARA DJS
                    LATINOS</span></h1>
            <p data-aos="fade-right" data-aos-delay="500">Descarga edits, intro/outro, mashups y versiones listas para
                pista.
            </p>
            <ul>
            ...
            <div class="hero-buttons">
                <a href="{{ route('plans') }}" data-aos="fade-right" data-aos-delay="1100" class="btn-primary"><i
